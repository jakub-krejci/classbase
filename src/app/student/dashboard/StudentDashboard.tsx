        ...
        <a
            ...
            onMouseLeave={(e) => {
                if (!active) {
                    (e.currentTarget as HTMLElement).style.background =
                        "transparent";
                    (e.currentTarget as HTMLElement).style.color = D.txtSec;
                }
            }}
        >
            {icon}
...
function moduleStatus(pct: number, total: number) {
    ...
    if (pct === 100)
        return { label: "Dokončeno", color: D.success, bg: D.success + "20" };
    if (pct > 0)
        return { label: "Probíhá", color: D.warning, bg: D.warning + "20" };
...
export default function StudentDashboard({
    ...
    const continueEnrollment =
        enrollments.find((e) => {
            ...
            const done = (e.modules?.lessons ?? []).filter((l: any) =>
    ...
    const continueDone = (continueMod?.lessons ?? []).filter((l: any) =>
        completedSet.has(l.id),
    ).length;
    const continuePct =
        continueTotal > 0
            ? Math.round((continueDone / continueTotal) * 100)
            : 0;

    const pendingSet = new Set(
        attempts
            .filter((a: any) => ["submitted", "timed_out"].includes(a.status))
            .map((a: any) => a.test_id),
    );
    ...
    const monthName = now.toLocaleDateString("cs-CZ", {
        month: "long",
        year: "numeric",
    });
    ...
    const moduleCards = enrollments.map((e) => {
        ...
        const done = (m?.lessons ?? []).filter((l: any) =>
            completedSet.has(l.id),
        ).length;
    ...
    async function handleEnroll() {
        ...
        try {
            const res = await fetch("/api/enroll", {
                ...
                body: JSON.stringify({
                    access_code: enrollCode.trim().toUpperCase(),
                }),
            });
            const data = await res.json();
            if (!res.ok) {
                setEnrollErr(data.error ?? "Chyba");
                setEnrolling(false);
                return;
            }
            setEnrollOpen(false);
                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Zadejte kód, který vám dal učitel
                            </p>
                            <input
                                value={enrollCode}
                                onChange={(e) =>
                                ...
                                onKeyDown={(e) =>
                                    e.key === "Enter" && handleEnroll()
                                }
                                placeholder="např. MAT-2026"
                                autoFocus
                                style={{
                                    width: "100%",
                                    padding: "11px 14px",
                ...
                >
                    ...
                    >
                                    ...
                                    {[
                                        {
                                            ...
                                            label: "Spustit Python editor",
                                            href: "/student/python",
                                        },
                                        {
                                            icon: "/icons/pygame.png",
                                            label: "PyGame Edit",
                                            href: "/student/pygame",
                                        },
                                        {
                                            icon: "/icons/jupyter.png",
                                            label: "Otevřít Jupyter Notebook",
                                            href: "/student/jupyter",
                                        },
                                        {
                                            icon: "/icons/html.png",
                                            label: "Spustit HTML editor",
                                            href: "/student/html",
                                        },
                                        {
                                            icon: "/icons/database.png",
                                            label: "Spustit SQL editor",
                                            href: "/student/sql",
                                        },
                                    ].map(({ icon, label, href }) => (
                                        <a
                        ...
                        >
                            ...
                            {continueEnrollment ? (
                                <a
                                    href={`/student/modules/${continueEnrollment.module_id}`}
                                    style={{
                                        ...card({
                                            padding: "20px 24px",
                                            background: accent,
                                ...
                                >
                                    ...
                                    >
                                        {continueDone}/{continueTotal} lekcí →
                                    </div>
                                </a>
                            ) : (
                                <button
                                ...
                                >
                                    ...
                                    Přihlásit se do prvního modulu
                                </button>
                            )}
                            ...
                            <div>
                                ...
                                {moduleCards.length === 0 ? (
                                    ...
                                    >
                                        ...
                                        >
                                            Zatím nejsi zapsán v žádném modulu.
                                        </div>
                                        <button
                                            onClick={() => setEnrollOpen(true)}
                                            style={{
                                        ...
                                        {moduleCards.map((m) => {
                                            ...
                                            return (
                                                <a
                                                    ...
                                                    className="mod-card bento-hover"
                                                    style={{
                                                        ...card({
                                                            textDecoration:
                                                                "none",
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        style={{
                                                            height: 120,
                                                            background: `linear-gradient(135deg, ${accent}25 0%, rgba(255,255,255,.04) 100%)`,
                                                            position:
                                                                "relative",
                                                            display: "flex",
                                                            alignItems:
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {t.category ?? "Test"}
                                                        {t.available_until
                                                            ? ` · do ${new Date(t.available_until).toLocaleDateString("cs-CZ")}`
                                                            : ""}
                                                    </div>
                                                </div>
                                                <div
                    ...
                    <div style={card({ padding: "16px" })}>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: 10, color: D.txtSec }}>
                                    Přihlašuj se každý den
                                </div>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div style={{ textAlign: "right" }}>
                                <div style={{ fontSize: 11, color: D.txtSec }}>
                                    🎮 XP
                                </div>
                                <div
                                    style={{
